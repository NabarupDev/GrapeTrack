    ...
    <div className="min-h-screen flex items-center justify-center bg-neutral-100">
      <div className="w-full max-w-md p-8 rounded-2xl shadow-2xl border border-neutral-200" style={{ background: 'linear-gradient(135deg, #f7f7f9 60%, #ece9f6 100%)', boxShadow: '0 8px 32px 0 rgba(31, 38, 135, 0.10)' }}>
        ...
        <form className="space-y-6">
          <div>
            <label className="block text-neutral-700 font-semibold mb-2">Name</label>
            <input type="text" className="w-full px-4 py-2 bg-neutral-50 border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-400 transition" placeholder="Your Name" required />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="password" className="w-full px-4 py-2 bg-neutral-50 border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-400 transition" placeholder="Create a password" required />
          </div>
          <button type="submit" className="w-full bg-gradient-to-r from-violet-600 to-indigo-500 hover:from-violet-700 hover:to-indigo-600 text-white font-bold py-2.5 rounded-xl shadow-md transition">Sign Up</button>
        </form>
